...
public class CaesarCipher2 {
    ...
    public String encrypt(String input, int keyone, int keysecond) {
        ...
        String shiftedAlphabetone = alphabet.substring(keyone) + alphabet.substring(0, keyone);
    ...
    String shiftedAlphabetsecond = alphabet.substring(keysecond) + alphabet.substring(0, keysecond);for(
    int i = 1;i<encrypted.length();i=i+2)
    {
        String encrypted;
        // Look at the ith character of encrypted (call it currChar)
        char currChar = encrypted.charAt(i);
